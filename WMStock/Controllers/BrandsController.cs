...
namespace WMStock.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BrandID,BrandName,CategoryID")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BrandID,BrandName,CategoryID")] Brand brand)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            return View(db.Brands.Where(x => x.BrandName.Contains(s) || s == null).ToList());
        }
    }
}
